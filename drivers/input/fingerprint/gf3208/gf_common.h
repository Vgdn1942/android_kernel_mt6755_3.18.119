...
#define GF_KEY_INPUT_POWER		KEY_F11
...
//[agold][xfl][20170630]
#define  GF_IOC_SPI_GET_CHIP_ID  	 _IO(GF_IOC_MAGIC, 18)
...
struct gf_device {
	...
	struct pinctrl_state *pins_miso_spi, *pins_miso_pullhigh, *pins_miso_pulllow, *pins_default;
	struct pinctrl_state *pins_reset_high, *pins_reset_low;
	struct pinctrl_state *pwr_output0, *pwr_output1;
#endif
};
