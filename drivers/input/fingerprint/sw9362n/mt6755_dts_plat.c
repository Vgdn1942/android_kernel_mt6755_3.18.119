...
#ifndef AGOLD_FINGERPRINT_COMPATIBLE
static int __init mt6755_dts_register_platform(void)
#else
int mt6755_dts_register_platform(void)
#endif
{
...
#ifndef AGOLD_FINGERPRINT_COMPATIBLE
module_init(mt6755_dts_register_platform);

static void __exit mt6755_dts__dev_exit(void)
{
}
module_exit(mt6755_dts__dev_exit);
...
#else
EXPORT_SYMBOL_GPL(mt6755_dts_register_platform);
#endif
