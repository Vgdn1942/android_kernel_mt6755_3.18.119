...
#define GTP_SUPPORT_I2C_DMA   1 //0      // if gt9xxf, better enable it if hardware platform supported
#define GTP_COMPATIBLE_MODE   0 //0       // compatible with GT9XXF
...
#define TPD_POWER_SOURCE    MT6328_POWER_LDO_VGP1      // define your power source for tp if needed
#endif
...
#define GTP_DMA_MAX_TRANSACTION_LENGTH  256 //255   // for DMA mode
