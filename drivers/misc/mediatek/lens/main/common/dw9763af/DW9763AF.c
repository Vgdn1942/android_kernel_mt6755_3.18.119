...
//static int AF_I2C_SLAVE_ADDR = 0x18;
...
static int s4AF_WriteReg(u16 a_u2Data)
{
	...
	if (i4RetValue < 0) {
	#ifdef AGOLD_JK_S5K3L8_COMPATIBLE
	LOG_INF("I2C send 0x18 failed,I2C send 0x1c started!!\n");
...
{
	LOG_INF("[zbl] DW9763AF_Release Start\n");
...
int DW9763AF_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock, int *pAF_Opened)
{
