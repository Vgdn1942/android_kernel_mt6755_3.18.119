...
extern void OV8856CheckLensVersion(int writeid);
			...
			*sensor_id = ((read_cmos_sensor(0x300B) << 8) | read_cmos_sensor(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				return ERROR_NONE;
 				...
 				#ifdef AGOLD_OV8856_OTP
 				OV8856CheckLensVersion(imgsensor.i2c_write_id);
 				#endif
				LOG_INF("i2c write id: 0x%x, sensor id: 0x%x, ov8856version = %d(0=r2a,1=r1a)\n", imgsensor.i2c_write_id,*sensor_id,ov8856version);	
				return ERROR_NONE;
				}
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] =	 
{
 ...
 { 3264, 2448,	  0,  0,   3264, 2448,  640,  480,   0,  0,  640,  480,	 0,  0,   640,  480}, //hight speed video 
