...
extern kal_bool read_s5k3l8_otp_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
extern bool s5k3l8CheckLensVersion(int id);
extern void S5K3L8_MIPI_update_wb_register_from_otp(void);
//extern bool S5K3L8CheckLensVersion(void);
//extern bool read_s5k3l8_eeprom( kal_uint16 addr, BYTE* data, kal_uint32 size);
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
		...
		//read_imx135_otp_mtk_fmt();
				...
				//S5K3L8CheckLensVersion();
			printk("[fj+++++++++++]");
				s5k3l8CheckLensVersion(imgsensor.i2c_write_id);
			printk("[fj--------------------]");
                return ERROR_NONE;
            }
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
		...
		case SENSOR_FEATURE_GET_PDAF_DATA:	
			...
			//S5K3L8_read_pdaf((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			read_s5k3l8_otp_eeprom((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;	
        /******************** PDAF END   <<< *********/
        default:
            break;
