...
static int ov13850_chip_ver = OV13850_R2A;
//sensor otp
extern void OV13850_otp_cali(unsigned char writeid);
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .cap = {
        .pclk = 448000000,//480000000, //neil 20150113
        .linelength = 4512,//4800,//neil 20150113
        .framelength = 3328,
        .startx = 0,
        .starty = 0,
...
static UINT32 return_sensor_id(void)
{
...
#if defined(AGOLD_TSC_OV13850_HV_MIRROR)
kal_uint8 mirro_flag=0;
#endif
...
#if defined(AGOLD_IMGSENSOR_OV13850_H_MIRROR)
		image_mirror = IMAGE_H_MIRROR;
	#elif defined(AGOLD_IMGSENSOR_OV13850_V_MIRROR)
		image_mirror = IMAGE_V_MIRROR;
	#elif defined(AGOLD_IMGSENSOR_OV13850_HV_MIRROR)
...
if (capture_first_flag == 0)
{
    ...
    if (currefps == 150) { //15fps for PIP
        //@@full_132PCLK_24.75
			...
			write_cmos_sensor(0x0303, 0x00);//
			write_cmos_sensor(0x3612, 0x08);// 0x09 for 100.8Mhz sysclk,0x08 for 112Mhz sysclk
		        write_cmos_sensor(0x3614, 0x2a);// neil add 20150113
			write_cmos_sensor(0x3501, 0xc0);//
			write_cmos_sensor(0x3702, 0x40);// ;add for VGA differences
			write_cmos_sensor(0x370a, 0x24);//
                        write_cmos_sensor(0x371b, 0x01); // neil add 20150113
                        write_cmos_sensor(0x3748, 0x21); // neil add 20150113
                        write_cmos_sensor(0x3730, 0x02); // neil add 20150113
                        write_cmos_sensor(0x3731, 0x5c); // neil add 20150113
                        write_cmos_sensor(0x3732, 0x02); // neil add 20150113
                        write_cmos_sensor(0x3733, 0x70); // neil add 20150113
			write_cmos_sensor(0x372a, 0x05); // neil add 20150113
                        write_cmos_sensor(0x3749, 0x22); // neil add 20150113
                        write_cmos_sensor(0x3738, 0x02); // neil add 20150113
                        write_cmos_sensor(0x3739, 0x72); // neil add 20150113
                        write_cmos_sensor(0x373a, 0x02); // neil add 20150113
                        write_cmos_sensor(0x373b, 0x74); // neil add 20150113
			write_cmos_sensor(0x372f, 0xa0);//
			write_cmos_sensor(0x3780, 0x90); //neil add 20150108
			write_cmos_sensor(0x3781, 0x00); //neil add 20150108
			write_cmos_sensor(0x3782, 0x01); //neil add 20150108
			write_cmos_sensor(0x403f, 0x40); //neil add 20150108
			write_cmos_sensor(0x3801, 0x0C);//
			write_cmos_sensor(0x3802, 0x00);// ;add for VGA differences
			write_cmos_sensor(0x3803, 0x04);//
			write_cmos_sensor(0x3805, 0x93);//
			...
			write_cmos_sensor(0x3836, 0x04);//
			write_cmos_sensor(0x3837, 0x01);//
			write_cmos_sensor(0x4020, 0x03);// neil add 20150113
			write_cmos_sensor(0x4021, 0x6C);// neil add 20150113
			write_cmos_sensor(0x4022, 0x0D);// neil add 20150113
			write_cmos_sensor(0x4023, 0x17);// neil add 20150113
			write_cmos_sensor(0x4024, 0x0d);// neil add 20150113
			write_cmos_sensor(0x4025, 0xFC);// neil add 20150113
			write_cmos_sensor(0x4026, 0x0D);// neil add 20150113
			write_cmos_sensor(0x4027, 0xFF);// neil add 20150113
			write_cmos_sensor(0x403F, 0x40);// neil add 20150113
			write_cmos_sensor(0x402a, 0x04);//;add for VGA differences
			write_cmos_sensor(0x402b, 0x08);//;add for VGA differences
			write_cmos_sensor(0x402c, 0x02);//;add for VGA differences
			write_cmos_sensor(0x402e, 0x0c);//;add for VGA differences
...
static void normal_video_setting(kal_uint16 currefps)
{
    LOG_INF("E! currefps:%d\n",currefps);
		...
		write_cmos_sensor(0x0302, 0x32);
		write_cmos_sensor(0x0303, 0x00);
		write_cmos_sensor(0x3612, 0x08);// neil add 20150113
	        write_cmos_sensor(0x3614, 0x2a);// neil add 20150113
		write_cmos_sensor(0x3501, 0xc0);
		write_cmos_sensor(0x3702, 0x40);
		write_cmos_sensor(0x370a, 0x24);
...
static void hs_video_setting(void)
{
    ...
    write_cmos_sensor(0x0100, 0x00);//
		...
		write_cmos_sensor(0x0302, 0x28);
		write_cmos_sensor(0x0303, 0x00);
	  write_cmos_sensor(0x3612, 0x27);// neil add 20151020
		write_cmos_sensor(0x3614, 0x28);// neil add 20151020
		write_cmos_sensor(0x3501, 0x20);
		write_cmos_sensor(0x3702, 0x5a);
		write_cmos_sensor(0x370a, 0xa9);
    write_cmos_sensor(0x371b, 0x00); // neil add 20151020
    write_cmos_sensor(0x3748, 0x00); // neil add 20151020
    write_cmos_sensor(0x3730, 0x00); // neil add 20151020
    write_cmos_sensor(0x3731, 0x00); // neil add 20151020
    write_cmos_sensor(0x3732, 0x00); // neil add 20151020
    write_cmos_sensor(0x3733, 0x00); // neil add 20151020
		write_cmos_sensor(0x372a, 0x00); // neil add 20151020
    write_cmos_sensor(0x3749, 0x00); // neil add 20151020
    write_cmos_sensor(0x3738, 0x00); // neil add 20151020
    write_cmos_sensor(0x3739, 0x00); // neil add 20151020
    write_cmos_sensor(0x373a, 0x00); // neil add 20151020
    write_cmos_sensor(0x373b, 0x00); // neil add 20151020
		write_cmos_sensor(0x372f, 0x88);
		write_cmos_sensor(0x3780, 0x10); //neil add 20151020
		write_cmos_sensor(0x3781, 0x00); //neil add 20151020
		write_cmos_sensor(0x3782, 0x00); //neil add 20151020
		write_cmos_sensor(0x403f, 0x7f); //neil add 20151020
		write_cmos_sensor(0x3800, 0x00);
    ...
    write_cmos_sensor(0x380f, (imgsensor_info.hs_video.framelength & 0xFF));         // vts
		...
		write_cmos_sensor(0x4020, 0x00);// neil add 20151020
		write_cmos_sensor(0x4021, 0xe4);// neil add 20151020
		write_cmos_sensor(0x4022, 0x03);// neil add 20151020
		write_cmos_sensor(0x4023, 0x3f);// neil add 20151020
		write_cmos_sensor(0x4024, 0x04);// neil add 20151020
		write_cmos_sensor(0x4025, 0x20);// neil add 20151020
		write_cmos_sensor(0x4026, 0x04);// neil add 20151020
		write_cmos_sensor(0x4027, 0x25);// neil add 20151020
		write_cmos_sensor(0x403F, 0x7f);// neil add 20151020
		write_cmos_sensor(0x402a, 0x02);// neil add 20151020
		write_cmos_sensor(0x402b, 0x04);// neil add 20151020
		write_cmos_sensor(0x402c, 0x06);// neil add 20151020
		write_cmos_sensor(0x402e, 0x08);// neil add 20151020
		write_cmos_sensor(0x402f, 0x04);// neil add 20151020
		write_cmos_sensor(0x4501, 0x3c);
...
void OV13850CheckLensVersion(void);

extern int is_dw9714;
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    kal_uint8 i = 0;
    kal_uint8 retry = 2;
    //sensor have two i2c address 0x6c 0x6d & 0x21 0x20, we should detect the module used i2c address
	LOG_INF("[xfl-i-1]i2c write id: 0x%x\n", imgsensor_info.i2c_addr_table[0]);
    //while (1) {
        ...
        do {
            *sensor_id = return_sensor_id();
            if (*sensor_id == imgsensor_info.sensor_id) {
                LOG_INF("[xfl-i-2]i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
...
//                is_dw9714 = 0;
    ...
    LOG_INF("ov13850 Read sensor id ok, id: 0x%x\n", *sensor_id);
    return ERROR_NONE;
}
...
void OV13850CheckLensVersion(void)
{
	...
	if(g_cur_cam_sensor==1 || g_cur_cam_sensor ==2)
	{
		if(!checkVersion)
		{
			...
			write_cmos_sensor(0x5002, (0x00 & 0x02) | (temp1 & (~0x02)));
			//check awb group
			...
			write_cmos_sensor(0x3d88, 0x72);
			write_cmos_sensor(0x3d89, 0x20);

			// partial mode OTP write end address
			if(ov13850_chip_ver == OV13850_R1A)	{
			write_cmos_sensor(0x3d8A, 0x72);
			write_cmos_sensor(0x3d8B, 0x2f);
			}else{
			write_cmos_sensor(0x3d8A, 0x73);
			write_cmos_sensor(0x3d8B, 0xbe);
			}
			// read otp into buffer
			write_cmos_sensor(0x3d81, 0x01);
			mdelay(5);
			flag = read_cmos_sensor(0x7220);
			CAMVER_INFO("read info flag (0x7220)=0x%02x", flag);
			...
			if(index <= 3)
			{
			    if(ov13850_chip_ver == OV13850_R1A)
			    {
			        CAMVER_INFO("ov13850_chip_ver == OV13850_R1A\n");
				    agold_camera_info[g_cur_cam_sensor-1].mf_id = read_cmos_sensor(0x721c + 5*index);	//0x7221 0x7226 0x722B
				    agold_camera_info[g_cur_cam_sensor-1].lens_id = read_cmos_sensor(0x721d + 5*index);	//0x7222 0x7227 0x722C
				    agold_camera_info[g_cur_cam_sensor-1].date[0] = read_cmos_sensor(0x721e + 5*index);	//0x7223 0x7228 0x722D
				    agold_camera_info[g_cur_cam_sensor-1].date[1] = read_cmos_sensor(0x721f + 5*index);	//0x7224 0x7229 0x701E
				    agold_camera_info[g_cur_cam_sensor-1].date[2] = read_cmos_sensor(0x7220 + 5*index);	//0x7225 0x722A 0x722F
				    #ifndef YH_OTP_NO_SENID
			        agold_camera_info[g_cur_cam_sensor-1].sen_id = read_cmos_sensor(0x723e + 3*index);	//0x7241 0x7244 0x7247
			        #endif
					printk("otp_log read sen_id,id=0x%2x,addr=0x%4x\n", agold_camera_info[g_cur_cam_sensor-1].sen_id, 0x723e + 3*index);
			    }
			    else
			    {
			        CAMVER_INFO("ov13850_chip_ver == OV13850_R2A\n");
			        agold_camera_info[g_cur_cam_sensor-1].mf_id = read_cmos_sensor(0x7219 + 8*index);	//0x7221 0x7229
				    agold_camera_info[g_cur_cam_sensor-1].lens_id = read_cmos_sensor(0x721a + 8*index);	//0x7222 0x722A
				    agold_camera_info[g_cur_cam_sensor-1].date[0] = read_cmos_sensor(0x721b + 8*index);	//0x7223 0x722B
				    agold_camera_info[g_cur_cam_sensor-1].date[1] = read_cmos_sensor(0x721c + 8*index);	//0x7224 0x722C
				    agold_camera_info[g_cur_cam_sensor-1].date[2] = read_cmos_sensor(0x722d + 8*index);	//0x7225 0x722D
				    agold_camera_info[g_cur_cam_sensor-1].sen_id = read_cmos_sensor(0x73aa + 3*index);	//0x73ad 0x73b0 0x73b0
					printk("otp_log read sen_id,id=0x%2x,addr=0x%4x\n", agold_camera_info[g_cur_cam_sensor-1].sen_id, 0x73aa + 3*index);
			    }

			}
			else
			{
				CAMVER_INFO("[OV13850OTP]invalid info data\n");
			}


			for(index = 0x7240; index <= 0x7247; index++)
			{
				write_cmos_sensor(index, 0x00);
			}


			CAMVER_INFO("get otp info %x %x %d.%d.%d %x %x\n",
		    ...
		    #if defined(AGOLD_TSC_OV13850_HV_MIRROR)
		    CAMVER_INFO("mfid = %d\n",agold_camera_info[g_cur_cam_sensor-1].mf_id);
			if (agold_camera_info[g_cur_cam_sensor-1].mf_id==0xfc)
			{
				mirro_flag=1;                //	imgsensor_info.sensor_output_dataformat=SENSOR_OUTPUT_FORMAT_RAW_B;
			}
			#endif
			//set 0x5002[1] to “1”
			temp1 = read_cmos_sensor(0x5002);
			write_cmos_sensor(0x5002, (0x02 & 0x02) | (temp1 & (~0x02)));
		}
		write_cmos_sensor(0x0100,0x00);// ; stream off

	}else{
		printk("get cur sensor index error!!!\n");
	}
	printk("OV13850CheckLensVersion: exit! \n");
}
...
static kal_uint32 open(void)
{
    ...
    sensor_init();
	  //for OTP
	#if defined(AGOLD_OV13850_OTP)
	OV13850_otp_cali(imgsensor.i2c_write_id);
    #endif
	write_cmos_sensor(0x0100, 0x00);
                             ...
                             UINT8 *feature_para,UINT32 *feature_para_len)
{
    ...
    switch (feature_id) {
	    ...
	    #if defined(CONFIG_MTK_CAMERA_VERSION)	//Lancelot 2014-06-10
	    //if(ret == ERROR_NONE)
            	OV13850CheckLensVersion();
	    #endif
            break;
