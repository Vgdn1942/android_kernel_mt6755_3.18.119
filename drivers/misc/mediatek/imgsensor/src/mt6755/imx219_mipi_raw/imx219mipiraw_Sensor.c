 ...
 *============================================================================
 ****************************************************************************/
#ifdef AGOLD_IMX219_2LANE
#include "imx219mipiraw_Sensor_2lane"
#else
...
extern kal_bool IMX219MIPI_ReadIDFromOtp(kal_uint8 i2c_write_id);
		...
		do 
		{
			*sensor_id = return_sensor_id();
			...
			{				
				...
				IMX219MIPI_ReadIDFromOtp(imgsensor.i2c_write_id);	  
				return ERROR_NONE;
			}	
