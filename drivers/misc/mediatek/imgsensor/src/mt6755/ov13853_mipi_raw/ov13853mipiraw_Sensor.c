...
extern void ov13853_update_otp(void);
extern void OV13853CheckLensVersion(kal_uint8 i2c_write_id);
extern kal_bool read_ov13853_otp_pdaf(kal_uint16 addr, unsigned char * data, kal_uint32 size);
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        do {
            *sensor_id = return_sensor_id();
            ...
            {
                OV13853CheckLensVersion(imgsensor.i2c_write_id);
   ...
   // unsigned long long *feature_return_para=(unsigned long long *) feature_para;
    ...
    switch (feature_id) {
        ...
        case SENSOR_FEATURE_GET_PDAF_DATA:
            LOG_INF("ov13853 SENSOR_FEATURE_GET_PDAF_DATA :\n");
			read_ov13853_otp_pdaf((kal_uint16 )(*feature_data),(char*)(uintptr_t)(*(feature_data+1)),(kal_uint32)(*(feature_data+2)));
			break;
