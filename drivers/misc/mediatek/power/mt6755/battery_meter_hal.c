...
#ifdef CONFIG_OZ8806_SUPPORT
static kal_int32 fgauge_get_temp(void *data)
{
    //*(kal_int32*)(data) = oz8806_get_simulated_temp();
    *(kal_int32*)(data) = oz8806_get_battery_temp();
    return STATUS_OK;
}
#endif
#endif
...
static signed int fgauge_meta_cali_car_tune_value(void *data)
{
	...
	if (g_meta_input_cali_current != 0) {
		...
		if (dvalue != 0)
			...
			cali_car_tune = 1000;
			pr_err("fgauge_meta_cali_car_tune_value divide 0,set car_tune_value to 1000..\n ");
		}
