...
/**********************************************************
  ...
  *
  *********************************************************/
unsigned int ncp1854_read_interface (unsigned char RegNum, unsigned char *val, unsigned char MASK, unsigned char SHIFT)
{   
...
unsigned int ncp1854_config_interface (unsigned char RegNum, unsigned char val, unsigned char MASK, unsigned char SHIFT)
{
    unsigned char ncp1854_reg = 0;
    int ret = 0;
...
#ifdef CONFIG_OF
	pr_notice("[ncp1854_init] init start with i2c DTS\n");
#else
