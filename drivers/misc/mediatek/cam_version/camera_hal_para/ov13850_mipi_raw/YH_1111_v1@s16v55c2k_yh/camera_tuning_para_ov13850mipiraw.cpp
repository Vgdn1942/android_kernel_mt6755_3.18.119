...
{{                                                                                                       
    ...
    ISPMulitCCM:{                                                                                       
        ...
        17326,      // i4B_STD
            ...
            0,      // i4B_MIN
        { // i4P00[9]                                                                                    
            7522500, -1760000, -640000, -1797500, 7332500, -420000, -502500, -3762500, 9392500
        },                                                                                               
        { // i4P10[9]                                                                                    
            5133971, -5848465, 731446, -444931, -344198, 808571, 273237, 1830375, -2117818
        },                                                                                               
        { // i4P01[9]                                                                                    
            4953911, -5720230, 781422, -662826, -788462, 1474186, 59584, 401669, -481506
        },                                                                                               
        { // i4P20[9]                                                                                    
            0,  0,   0,  0,   0,  0, 0,  0,  0              
        },                                                                                               
...
{                                                                                                        
 ...
 // Predictor gain
 {
	...
	{							                                
		...
		// Cloudy daylight						              
		{						                                
                    258,    // PCloudyRightBound
                    83,    // PCloudyLeftBound
                    -305,    // PCloudyUpperBound
                    -405    // PCloudyLowerBound
		},						                              
		// Shade						                        
		{						                                
                    358,    // PShadeRightBound
                    83,    // PShadeLeftBound
                    -305,    // PShadeUpperBound
                    -405    // PShadeLowerBound
		},						                              
		// Twilight						                      
		{						                                
                    -107,    // PTwiRightBound
		...
		{						                                
                    ...
                    -368,    // PWFluoLeftBound
                    -298,    // PWFluoUpperBound
                    -446    // PWFluoLowerBound
		},						                              
		// Incandescent						                  
		{						                                
                    -168,    // PIncaRightBound
