...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        512,      // i4B_MIN
        {  // i4P00[9]
            7540000, -1692500, -730000, -1105000, 5870000, 347500, 90000, -3150000, 8177500
        },
        {  // i4P10[9]
            1831013, -2004874, 178494, 308890, -567141, 253542, 326236, 414013, -738724
        },
        {  // i4P01[9]
            1008863, -1329337, 315547, -4548, -677515, 681370, 105855, -742853, 648525
        },
        {  // i4P20[9]
        ...
        {
            {
                ...
                // PWB light area
                {
                    ...
                    -295    // PDayLowerBound
                        ...
                        // Cloudy daylight
                        {
                    218,    // PCloudyRightBound
                    43,    // PCloudyLeftBound
                    -150,    // PCloudyUpperBound
                    -295    // PCloudyLowerBound
                        },
                        // Shade
                        {
                    318,    // PShadeRightBound
                    43,    // PShadeLeftBound
                    -150,    // PShadeUpperBound
                    ...
                    -385    // PFluoLowerBound
                        ...
                        // Warm fluorescent
                        {
                    -222,    // PWFluoRightBound
                    -422,    // PWFluoLeftBound
                    -160,    // PWFluoUpperBound
                    -385    // PWFluoLowerBound
                        },
                        // Incandescent
                        {
                    -222,    // PIncaRightBound
