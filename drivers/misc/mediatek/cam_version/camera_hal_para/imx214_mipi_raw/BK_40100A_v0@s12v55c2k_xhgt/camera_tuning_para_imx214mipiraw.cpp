...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        512,      // i4B_MIN
        {  // i4P00[9]
            8572500, -3017500, -437500, -1652500, 7300000, -525000, -277500, -3032500, 8427500
        },
        {  // i4P10[9]
            3047681, -3713383, 670595, -231981, -695815, 919784, 227936, 1075476, -1316680
        },
        {  // i4P01[9]
            2859147, -3369762, 514938, -524285, -767225, 1292298, 43334, -127345, 67593
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    59,    // PCloudyLeftBound
                    -283,    // PCloudyUpperBound
                    -408    // PCloudyLowerBound
                },
                // Shade
                {
                    334,    // PShadeRightBound
                    59,    // PShadeLeftBound
                    -283,    // PShadeUpperBound
                    -408    // PShadeLowerBound
                },
                // Twilight
                {
                    -106,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    ...
                    -476,    // PWFluoLeftBound
                    -293,    // PWFluoUpperBound
                    -492    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -276,    // PIncaRightBound
