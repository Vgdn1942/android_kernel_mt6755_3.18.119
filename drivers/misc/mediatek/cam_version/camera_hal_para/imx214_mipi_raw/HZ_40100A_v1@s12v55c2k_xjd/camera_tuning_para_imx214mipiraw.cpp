...
#include INCLUDE_FILENAME_ISP_REGS_PARAM
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        512,      // i4B_MIN
        {  // i4P00[9]
            8395000, -3117500, -157500, -1392500, 6777500, -260000, 32500, -3030000, 8117500
        },
        {  // i4P10[9]
            1969042, -2286291, 309236, 93084, -234204, 125999, 137475, -554989, 423296
        },
        {  // i4P01[9]
            1524050, -1802070, 265603, -194854, -304219, 480609, 46412, -1540579, 1496353
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    ...
                    -354,    // PCloudyUpperBound
                    -473    // PCloudyLowerBound
                },
                // Shade
                {
                    397,    // PShadeRightBound
                    122,    // PShadeLeftBound
                    -354,    // PShadeUpperBound
                    -473    // PShadeLowerBound
                },
                // Twilight
                {
                    -40,    // PTwiRightBound
        ...
        // Algorithm Tuning Parameter
        {
            ...
            0,
                ...
                // Preference gain for each light source
                {
        	        ...
        	        {
                    {500, 512, 512}, {500, 512, 512}, {500, 512, 512}, {490, 512, 512}, {490, 512, 512}, {490, 512, 512}, {490, 512, 512}, {490, 512, 512}, {490, 512, 512}, {490, 512, 512}, 
                    {450, 512, 512}, {450, 512, 512}, {450, 512, 512}, {400, 512, 512}, {440, 512, 512}, {440, 512, 512}, {440, 512, 512}, {440, 512, 512}, {440, 512, 512}
                    }, // F
                    {
                        {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512},
                        {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
