...
static DEFINE_MUTEX(lsm6ds3_gyro_mutex);
/*
...
static int lsm6ds3_gyro_get_data(int* x ,int* y,int* z, int* status)
{
	...
	mutex_lock(&lsm6ds3_gyro_mutex);
	LSM6DS3_ReadGyroData(priv->client, buff, LSM6DS3_BUFSIZE);
	mutex_unlock(&lsm6ds3_gyro_mutex);
...
extern struct i2c_client *lsm6ds3_sc_i2c_client;
#endif
static int lsm6ds3_gyro_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
...
#ifdef CONFIG_CUSTOM_KERNEL_STEP_COUNTER
	lsm6ds3_sc_i2c_client = new_client;	
#endif
...
{
	const char *name = "mediatek,lsm6ds3gy";
