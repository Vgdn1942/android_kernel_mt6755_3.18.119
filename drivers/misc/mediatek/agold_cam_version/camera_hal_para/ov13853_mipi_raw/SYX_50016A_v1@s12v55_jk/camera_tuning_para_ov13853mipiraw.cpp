...
#include "camera_AE_PLineTable_ov13853mipiraw.h"
#include "camera_info_ov13853mipiraw.h"
...
const NVRAM_CAMERA_3A_STRUCT CAMERA_3A_NVRAM_DEFAULT_VALUE =
{
    ...
    // AE NVRAM
    {
        // rDevicesInfo
        {
            ...
            10001,    // u4Video1ExpUnit
            120,    // u4Video1MaxFrameRate
            1024,    // u4Video12PreRatio, 1024 base = 1x
            10001,    // u4Video2ExpUnit
            30,    // u4Video2MaxFrameRate
            1024,    // u4Video22PreRatio, 1024 base = 1x
            10001,    // u4Custom1ExpUnit
            30,    // u4Custom1MaxFrameRate
            1024,    // u4Custom12PreRatio, 1024 base = 1x
            10001,    // u4Custom2ExpUnit
            30,    // u4Custom2MaxFrameRate
            1024,    // u4Custom22PreRatio, 1024 base = 1x
            10001,    // u4Custom3ExpUnit
            30,    // u4Custom3MaxFrameRate
            1024,    // u4Custom32PreRatio, 1024 base = 1x
            10001,    // u4Custom4ExpUnit
            30,    // u4Custom4MaxFrameRate
            1024,    // u4Custom42PreRatio, 1024 base = 1x
            10001,    // u4Custom5ExpUnit
        ...
        {
          {
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    278,    // PCloudyRightBound
                    103,    // PCloudyLeftBound
                    -302,    // PCloudyUpperBound
                    -397    // PCloudyLowerBound
                },
                // Shade
                {
                    378,    // PShadeRightBound
                    103,    // PShadeLeftBound
                    -302,    // PShadeUpperBound
                    -397    // PShadeLowerBound
                },
                // Twilight
                {
                    -1,    // PTwiRightBound
                ...
                // Warm fluorescent
                {
                    -150,    // PWFluoRightBound
                    -350,    // PWFluoLeftBound
                    -312,    // PWFluoUpperBound
                    -481    // PWFluoLowerBound
                },
                // Incandescent
                {
                    -150,    // PIncaRightBound
