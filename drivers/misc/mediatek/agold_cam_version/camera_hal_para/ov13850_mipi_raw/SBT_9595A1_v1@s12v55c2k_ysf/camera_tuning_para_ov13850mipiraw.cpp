...
{{                                                                                                       
    ...
    ISPMulitCCM:{
      Poly22:{
        ...
        0,      // i4B_MIN
        {  // i4P00[9]
            7240000, -2687500, 565000, -1427500, 5890000, 652500, -567500, -4100000, 9790000
        },
        {  // i4P10[9]
            3233564, -3537594, 289486, 364662, -759968, 386786, 1441941, 1757797, -3187623
        },
        {  // i4P01[9]
            2614972, -2943134, 308629, -155436, -1249857, 1393076, 693348, 34457, -707601
        },
        {  // i4P20[9]
            0, 0, 0, 0, 0, 0, 0, 0, 0
        },
    ...
    AWB_NVRAM_START
    {
		...
		{						                                
            ...
            // PWB light area
            {
                ...
                // Cloudy daylight
                {
                    228,    // PCloudyRightBound
                    53,    // PCloudyLeftBound
                    -284,    // PCloudyUpperBound
                    -383    // PCloudyLowerBound
                },
                // Shade
                {
                    328,    // PShadeRightBound
                    53,    // PShadeLeftBound
                    -284,    // PShadeUpperBound
                    -383    // PShadeLowerBound
                },
                // Twilight
                {
                    -93,    // PTwiRightBound
            ...
            // AWB preference color	
            {
                ...
                // Sunset Area
                {
                    -36,   // i4Sunset_BoundXr_Thr
                    -359    // i4Sunset_BoundYr_Thr
                },
                // Shade F Area
                {
                    -219,   // i4BoundXrThr
        ...
        // Algorithm Tuning Parameter
        {
            ...
            // Preference gain for each light source
            {
                ...
                {
                    {512, 512, 585}, {512, 512, 585}, {512, 512, 585}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}
                }, // TUNGSTEN
                {
                    {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, {512, 512, 512}, 
